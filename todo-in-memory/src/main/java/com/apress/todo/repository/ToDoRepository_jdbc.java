...
@Repository ("jdbc")
public class ToDoRepository_jdbc implements CommonRepository<ToDo>{
	...
	private static final String SQL_UPDATE= "update todo set description= :description, modified= :modified, completed= :completed"
			+ " where id= :id";
	private static final String SQL_DELETE= "delete from todo where id= :id";

	private final NamedParameterJdbcTemplate jdbcTemplate;
	
	public ToDoRepository_jdbc(NamedParameterJdbcTemplate jdbcTemplate) {
	...
	public ToDo findById(String id) {
		try {
			...
			return this.jdbcTemplate.queryForObject(
					SQL_QUERY_FIND_BY_ID, namedParameters, toDoRowMapper);
